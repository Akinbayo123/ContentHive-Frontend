...
import { Home, Bookmark, ShoppingBag, Settings, LogOut, Menu, X, MessageSquare, CreditCard } from "lucide-react"
...
const navItems = [
  ...
  { href: "/dashboard/browse", label: "Browse Content", icon: ShoppingBag },
  { href: "/dashboard/favorites", label: "Favorites", icon: Bookmark },
  { href: "/dashboard/purchases", label: "Purchases", icon: CreditCard },
  { href: "/dashboard/chat", label: "Messages", icon: MessageSquare }, // Added chat navigation

...
export function ChatHeader({ selectedChat, otherUser, isOnline, isTyping, onBack }: ChatHeaderProps) {
    return (
        <div className="p-4 border-b border-border flex items-center gap-3">
            ...
            <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">{selectedChat.file?.title || "Purchase"}</p>
